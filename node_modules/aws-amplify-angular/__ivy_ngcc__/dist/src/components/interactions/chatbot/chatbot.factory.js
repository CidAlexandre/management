...
function ChatBotComponent_ng_template_3_Template(rf, ctx) { }
...
ChatBotComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ChatBotComponent, selectors: [["amplify-interactions"]], viewQuery: function ChatBotComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { framework: "framework", bot: "bot", title: "title", clearComplete: "clearComplete", conversationModeOn: "conversationModeOn", voiceConfig: "voiceConfig", voiceEnabled: "voiceEnabled", textEnabled: "textEnabled" }, outputs: { complete: "complete" }, decls: 6, vars: 0, consts: [[1, "amplify-component"], ["component-host", ""]], template: function ChatBotComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n\t\t");
        ɵngcc0.ɵɵelementStart(1, "div", 0);
        ɵngcc0.ɵɵtext(2, "\n\t\t\t");
        ɵngcc0.ɵɵtemplate(3, ChatBotComponent_ng_template_3_Template, 0, 0, "ng-template", 1);
        ɵngcc0.ɵɵtext(4, "\n\t\t");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtext(5, "\n\t");
