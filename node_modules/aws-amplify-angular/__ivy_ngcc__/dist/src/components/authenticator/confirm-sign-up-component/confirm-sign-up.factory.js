...
function ConfirmSignUpComponent_ng_template_3_Template(rf, ctx) { }
...
ConfirmSignUpComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ConfirmSignUpComponent, selectors: [["amplify-auth-confirm-sign-up"]], viewQuery: function ConfirmSignUpComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { usernameAttributes: "usernameAttributes", hide: "hide", framework: "framework", authState: "authState" }, decls: 6, vars: 0, consts: [["component-host", ""]], template: function ConfirmSignUpComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n\t\t");
        ɵngcc0.ɵɵelementStart(1, "div");
        ɵngcc0.ɵɵtext(2, "\n\t\t\t");
        ɵngcc0.ɵɵtemplate(3, ConfirmSignUpComponent_ng_template_3_Template, 0, 0, "ng-template", 0);
        ɵngcc0.ɵɵtext(4, "\n\t\t");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtext(5, "\n\t");
