...
function ConfirmSignInComponent_ng_template_3_Template(rf, ctx) { }
...
ConfirmSignInComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ConfirmSignInComponent, selectors: [["amplify-auth-confirm-sign-in"]], viewQuery: function ConfirmSignInComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { hide: "hide", framework: "framework", authState: "authState" }, decls: 6, vars: 0, consts: [["component-host", ""]], template: function ConfirmSignInComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n\t\t");
        ɵngcc0.ɵɵelementStart(1, "div");
        ɵngcc0.ɵɵtext(2, "\n\t\t\t");
        ɵngcc0.ɵɵtemplate(3, ConfirmSignInComponent_ng_template_3_Template, 0, 0, "ng-template", 0);
        ɵngcc0.ɵɵtext(4, "\n\t\t");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtext(5, "\n\t");
