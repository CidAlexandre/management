...
function SumerianSceneComponent_ng_template_1_Template(rf, ctx) { }
...
SumerianSceneComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: SumerianSceneComponent, selectors: [["amplify-sumerian-scene"]], viewQuery: function SumerianSceneComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { framework: "framework", sceneName: "sceneName" }, decls: 3, vars: 0, consts: [["component-host", ""]], template: function SumerianSceneComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n\t\t");
        ɵngcc0.ɵɵtemplate(1, SumerianSceneComponent_ng_template_1_Template, 0, 0, "ng-template", 0);
        ɵngcc0.ɵɵtext(2, "\n\t");
