...
S3ImageComponentCore.ɵfac = function S3ImageComponentCore_Factory(t) { return new (t || S3ImageComponentCore)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.AmplifyService)); };
S3ImageComponentCore.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: S3ImageComponentCore, selectors: [["amplify-s3-image-core"]], inputs: { data: "data", path: "path", options: "options" }, outputs: { selected: "selected" }, decls: 3, vars: 1, consts: [[1, "amplify-image", 3, "src", "click"]], template: function S3ImageComponentCore_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n  ");
        ɵngcc0.ɵɵelementStart(1, "img", 0);
        ɵngcc0.ɵɵlistener("click", function S3ImageComponentCore_Template_img_click_1_listener() { return ctx.onImageClicked(); });
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtext(2, "\n");
    } if (rf & 2) {
        ɵngcc0.ɵɵadvance(1);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(S3ImageComponentCore, [{
        type: Component,
        args: [{
