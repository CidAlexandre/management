...
import * as ɵngcc3 from '../s3-image-component/s3-image.component.core';

function S3AlbumComponentCore_amplify_s3_image_core_5_Template(rf, ctx) { if (rf & 1) {
    var _r3 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "amplify-s3-image-core", 3);
    ɵngcc0.ɵɵlistener("selected", function S3AlbumComponentCore_amplify_s3_image_core_5_Template_amplify_s3_image_core_selected_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r3); var ctx_r2 = ɵngcc0.ɵɵnextContext(); return ctx_r2.onImageSelected($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
S3AlbumComponentCore.ɵfac = function S3AlbumComponentCore_Factory(t) { return new (t || S3AlbumComponentCore)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.AmplifyService)); };
S3AlbumComponentCore.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: S3AlbumComponentCore, selectors: [["amplify-s3-album-core"]], inputs: { data: "data", path: "path", options: "options" }, outputs: { selected: "selected" }, decls: 9, vars: 1, consts: [[1, "amplify-album"], [1, "amplify-album-container"], ["class", "amplify-image-container", 3, "path", "options", "selected", 4, "ngFor", "ngForOf"], [1, "amplify-image-container", 3, "path", "options", "selected"]], template: function S3AlbumComponentCore_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtext(0, "\n");
        ɵngcc0.ɵɵelementStart(1, "div", 0);
        ɵngcc0.ɵɵtext(2, "\n  ");
        ɵngcc0.ɵɵelementStart(3, "div", 1);
        ɵngcc0.ɵɵtext(4, "\n    ");
        ɵngcc0.ɵɵtemplate(5, S3AlbumComponentCore_amplify_s3_image_core_5_Template, 1, 2, "amplify-s3-image-core", 2);
        ɵngcc0.ɵɵtext(6, "\n  ");
        ɵngcc0.ɵɵelementEnd();
        ɵngcc0.ɵɵtext(7, "\n");
        ɵngcc0.ɵɵelementEnd();
    ...
    } }, directives: [ɵngcc2.NgForOf, ɵngcc3.S3ImageComponentCore], encapsulation: 2 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(S3AlbumComponentCore, [{
    ...
    }], function () { return [{ type: ɵngcc1.AmplifyService }]; }, { selected: [{
            type: Output
        }], data: [{
            type: Input
        }], path: [{
